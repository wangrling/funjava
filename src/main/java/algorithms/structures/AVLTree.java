 ...
 * trees are more rigidly(嚴格) balanced, they are faster than red-black trees for
...
public class AVLTree<T extends Comparable<T>> extends BinarySearchTree<T> {
    ...
    protected Node<T> addValue(T id) {
        ...
        while (nodeAdded != null) {
            ...
            // If height before and after balance is the same, stop going the tree.
    ...
    protected static class AVLNode<T extends Comparable<T>> extends Node<T> {
        // Node中已經包含lesser, greater, parent,
        // 平衡樹增加height.
    ...
    protected static class AVLTreePrinter {
        ...
        private static <T extends Comparable<T>> String getString(AVLNode<T> node,
            ...
            if (children != null) {
                ...
                if (children.size() >= 1) {
                    builder.append(getString((AVLNode<T>)
